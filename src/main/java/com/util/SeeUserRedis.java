...
@Component("seeUserRedis")
public class SeeUserRedis implements RedisUtil<String,String, SeeUser>{
    @Resource(name="redisTemplate")
    private RedisTemplate redisTemplate;

    private Logger logger = Logger.getLogger(String.valueOf(SeeUserRedis.class));
